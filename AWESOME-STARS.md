...
- [brltty/brltty](https://github.com/brltty/brltty) - Screen reader for braille devices (Linux, Android, Windows).
...
- [Azure/Industrial-IoT](https://github.com/Azure/Industrial-IoT) - OPC Publisher
...
- [quantumlib/qsim](https://github.com/quantumlib/qsim) - Fast C++ and Python library for state-vector simulation of quantum circuits.
...
- [flutter-team-archive/photobooth](https://github.com/flutter-team-archive/photobooth) - Google I/O 2021 Photo Booth built with Flutter and Firebase
...
- [SidharthArya/powerido](https://github.com/SidharthArya/powerido) - 
...
- [pahanini/go-grpc-bidirectional-streaming-example](https://github.com/pahanini/go-grpc-bidirectional-streaming-example) - gRPC bidirectional streaming example written in golang
...
- [uber/uReplicator](https://github.com/uber/uReplicator) - Improvement of Apache Kafka Mirrormaker
...
- [apache/incubator-kie-optaplanner](https://github.com/apache/incubator-kie-optaplanner) - OplaPlanner has moved to https://github.com/apache/incubator-kie-drools. This repository is archived. OptaPlanner is an AI constraint solver in Java to optimize the vehicle routing problem, employee r
...
- [intel/analytics-zoo](https://github.com/intel/analytics-zoo) - Distributed Tensorflow, Keras and PyTorch on Apache Spark/Flink & Ray
...
- [mongodb-developer/GenAI-Showcase](https://github.com/mongodb-developer/GenAI-Showcase) - MongoDB's Generative AI Showcase: an exhaustive collection of examples and sample applications covering Retrieval-Augmented Generation (RAG), AI agents, and industry-specific use cases.
...
- [Saiyan-World/grounded-segment-any-parts](https://github.com/Saiyan-World/grounded-segment-any-parts) - Grounded Segment Anything: From Objects to Parts
...
- [OpenMOSS/MOSS-Transcribe-Diarize](https://github.com/OpenMOSS/MOSS-Transcribe-Diarize) - A 0.9B model for long-form transcription in 50+ languages with speaker diarization, timestamps, and acoustic event awareness
...
- [gabrielmittag/NISQA](https://github.com/gabrielmittag/NISQA) - NISQA - Non-Intrusive Speech Quality and TTS Naturalness Assessment
...
- [juglab/n2v](https://github.com/juglab/n2v) - This is the implementation of Noise2Void training.
...
- [antgroup/echomimic_v3](https://github.com/antgroup/echomimic_v3) - [AAAI 2026] EchoMimicV3: 1.3B Parameters are All You Need for Unified Multi-Modal and Multi-Task Human Animation
...
- [bytedance/Sa2VA](https://github.com/bytedance/Sa2VA) - Official Repo For Pixel-LLM Codebase: Sa2VA (T-PAMI-26), SAMTok (CVPR-26), VRT (Arxiv-25), SaSaSa2VA (1-st solution for LSVOS)
...
- [AIStream-Peelout/flow-forecast](https://github.com/AIStream-Peelout/flow-forecast) - Deep learning PyTorch library for time series forecasting, classification, and anomaly detection (originally for flood forecasting).
...
- [facebookresearch/mvdust3r](https://github.com/facebookresearch/mvdust3r) - Open source impl of **MV-DUSt3R+ Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds** from Meta Reality Labs. Project page https://mv-dust3rp.github.io/
...
- [facebookresearch/Pitfalls-of-Memorization](https://github.com/facebookresearch/Pitfalls-of-Memorization) - Understanding the interplay between memorization and generalization in neural networks, featuring MAT, a learning algorithm to enhance robustness by mitigating spurious correlations.
...
- [ottowayi/pycomm3](https://github.com/ottowayi/pycomm3) - A Python Ethernet/IP library for communicating with Allen-Bradley PLCs.
...
- [google-deepmind/onetwo](https://github.com/google-deepmind/onetwo) - 
...
- [tensorflow/cloud](https://github.com/tensorflow/cloud) - ⛔️ DEPRECATED - The TensorFlow Cloud repository provides APIs that will allow to easily go from debugging and training your Keras and TensorFlow code in a local environment to distributed training in 
...
- [quantumlib/ReCirq](https://github.com/quantumlib/ReCirq) - Python modules for quantum computing applications and experiments using Cirq. Research using Cirq!
...
- [luxonis/oak-examples](https://github.com/luxonis/oak-examples) - Example projects we've done with OAK cameras
...
- [yoshitomo-matsubara/torchdistill](https://github.com/yoshitomo-matsubara/torchdistill) - A coding-free framework built on PyTorch for reproducible deep learning studies. PyTorch Ecosystem. 🏆26 knowledge distillation methods presented at TPAMI, CVPR, ICLR, ECCV, NeurIPS, ICCV, AAAI, etc ar
...
- [renpenguin/display3d](https://github.com/renpenguin/display3d) - A command line interface for rendering and animating 3D objects
...
- [Homebrew/homebrew-command-not-found](https://github.com/Homebrew/homebrew-command-not-found) - 💀 Ubuntu’s command-not-found equivalent for Homebrew on macOS (deprecated)
...
- [realworld-apps/angular-realworld-example-app](https://github.com/realworld-apps/angular-realworld-example-app) - Exemplary real world application built with Angular
...
- [DylanVann/react-native-fast-image](https://github.com/DylanVann/react-native-fast-image) - Performant React Native image component.
